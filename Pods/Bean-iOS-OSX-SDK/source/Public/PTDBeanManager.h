 ...
 */
- (void)beanManager:(PTDBeanManager*)beanManager didDiscoverBean:(PTDBean*)bean error:(NSError*)error strength:(NSNumber*)RSSI;
/**
 This method is deprecated. Use <[PTDBeanManager beanManager:didDiscoverBean:error:]> instead.
 @deprecated v0.3.2
 */
- (void)BeanManager:(PTDBeanManager*)beanManager didDiscoverBean:(PTDBean*)bean error:(NSError*)error strength:(NSNumber*)RSSI __attribute__((deprecated("use beanManager:didDiscoverBean:errror:")));
/**
